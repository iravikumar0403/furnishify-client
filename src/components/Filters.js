...
export const Filters = () => {
  ...
  return (
    <>
      <div className="filter-resp-toggle fs-3 text-secondary">
        <i
          className={showFilter ? "fa-solid fa-xmark" : "fa-solid fa-filter"}
          onClick={toggleFilter}
        ></i>
      </div>
      <aside className={`filter-section p-4 ${showFilter ? "active" : ""}`}>
